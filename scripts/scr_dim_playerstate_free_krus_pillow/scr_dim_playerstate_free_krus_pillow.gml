...
if (y!=yprevious && lastmove==1 ) sprite_index = asset_get_index( "spr_dim_" + sprit + "_move_left_pillow");
...
if (x<xprevious){ sprite_index = asset_get_index("spr_dim_" + sprit + "_move_left_pillow");lastmove = 1;}
//if (keyboard_check(vk_space) and keyl) {sprite_index =asset_get_index ("spr_dim_" + sprit +"_run_left");runspd = 8;}	
//lastmove = 1;}
if (x==xprevious && y==yprevious && lastmoves ==0) sprite_index = asset_get_index("spr_dim_" + sprits + "_cut_idle_r");
if (x==xprevious && y==yprevious && lastmove ==1) sprite_index = asset_get_index("spr_dim_" + sprit + "_cut_idle_l");
