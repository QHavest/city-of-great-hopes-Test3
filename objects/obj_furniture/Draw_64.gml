...
for (var i=0; i<itemCount01; i++){
	var arr = items_furniture01[| i]; 
	var itemL = arr[0];
	var itemR = arr[1];
}

var arr = items_furniture01[| notselected];
var itemL = arr[0];
var itemR = arr[1];
...
//Стрілочки і назва
draw_sprite_ext(sp_name_furniture, 0, guiW/2, guiH/6, 2, 2, 0, c_white, 1)
