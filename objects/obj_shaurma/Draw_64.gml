...
for (var i=0; i<itemCount01; i++){
	var arr = items_shaurma01[| i]; 
	var itemL = arr[0];
	var itemR = arr[1];
}

var arr = items_shaurma01[| notselected];
var itemL = arr[0];
var itemR = arr[1];
...
for (var i=0; i<itemCount; i++){
	var arr = items_shaurma[| i]; 
	var item = arr[0];
}

var arr = items_shaurma[| selected];
var item = arr[0];
var price = arr[1];
...
//Стрілочки і назва
draw_sprite_ext(sp_name_shaurma, 0, guiW/2, guiH/6, 2, 2, 0, c_white, 1)
