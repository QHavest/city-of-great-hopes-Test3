...
{ draw_sprite_ext(spr_dark,0,0,0,100,100,0,c_black,0.5);
	...
	{
		case 0 : 
		draw_sprite_stretched(spr_mp_Railway_station,0,bord_x_r,bord_y_r,r_w*kof_r,r_h*kof_r);
		...
		case 1 : 
		draw_sprite_stretched(spr_mp_Bazar,0,bord_x_b,bord_y_b,b_w*kof_b,b_h*kof_b) 
		spot += keyboard_check_pressed(vk_up)-keyboard_check_pressed(vk_down);
		...
		case 2 : 
		draw_sprite_stretched(spr_mp_Center,0,bord_x_c,bord_y_c,c_w*kof_c,c_h*kof_c) 
		spot += keyboard_check_pressed(vk_up)-keyboard_check_pressed(vk_down);
		...
		case 3 : 
		draw_sprite_stretched(spr_mp_Tukhlyanka,0,bord_x_t,bord_y_t,t_w*kof_t,t_h*kof_t) 
		spot += keyboard_check_pressed(vk_up)-keyboard_check_pressed(vk_down);
