...
if (val1 = 0){
	instance_create_depth(510,hresty,-300,obj_helps_sec);
	if (!instance_exists(obj_helps_sec)){
	chrest = instance_create_depth(510,hresty,-400,obj_hrest);
    ds_list_add (hrest_enemy, chrest);
	}}
	/*if (!instance_exists(obj_helps_sec)){
	chrest = instance_create_depth(510,hresty,-400,obj_hrest);
	ds_list_add (hrest_enemy, chrest)}}*/
